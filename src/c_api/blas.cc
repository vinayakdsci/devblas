...
extern "C" void
naive_igemm_ijk (const int *A, const int *B, int *C,
...
extern "C" void
naive_igemm_kij (const int *A, const int *B, int *C,
                 devblas_gemm_config_t *config)
{
    auto cppConfig = types::gemm_config_to_cpp (config);
...
extern "C" void
naive_sgemm_ijk (const float *A, const float *B, float *C,
                 devblas_gemm_config_t *config)
{
    auto cppConfig = types::gemm_config_to_cpp (config);
...
extern "C" void
naive_sgemm_kij (const float *A, const float *B, float *C,
                 devblas_gemm_config_t *config)
{
    auto cppConfig = types::gemm_config_to_cpp (config);
...
extern "C" void
tiled_sgemm (const float *A, const float *B, float *C,
             devblas_gemm_config_t *config)
{
    auto cppConfig = types::gemm_config_to_cpp (config);
...
extern "C" void
tiled_igemm (const int *A, const int *B, int *C, devblas_gemm_config_t *config)
{
    auto cppConfig = types::gemm_config_to_cpp (config);
...
extern "C" void
bench_igemm (devblas_igemm_fn fn, const char *name, int warmup_iters, int iter,
             devblas_gemm_config_t *config)
{
...
extern "C" void
bench_sgemm (devblas_sgemm_fn fn, const char *name, int warmup_iters, int iter,
             devblas_gemm_config_t *config)
{
    internal::bench::benchmark_gemm<float> (
        name ? name : "default_naive_sgemm", warmup_iters, iter, fn, config);
}
